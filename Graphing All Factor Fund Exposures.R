...
JPlot<-function(x,y,graphname,space=2){
        ...
        plot(x, y, xlim=range(x,na.rm=TRUE), 
             ...
             cex.main=.85, cex.sub=0.75, xlab="Dates", ylab="Fund Exposure (%)")
...
#Directory:
filepath<-"S:\\Data\\Scout\\Risk Monitoring\\Projects\\2016\\161024 Internationals History\\R Codes and Data\\All Fund Exposures 130331 to 160930.csv"
...
for (i in c(2:ncol(exposures))){
        if(i==parcheck){
                pdf(paper="USr",width=10,
                    file="S:\\Data\\Scout\\Risk Monitoring\\Projects\\2016\\161024 Internationals History\\R Codes and Data\\PDFs from R Code\\Fund Exposures 1.pdf")
